...
class ResponseBuilder:
    ...
    def _format_law_search_response(self, results: List, entities: dict) -> str:
        if not results:
            return (
                "عذراً، لم أتمكن من العثور على نص قانوني مؤكد ومطابق لسؤالك بنسبة 100% في القوانين والتشريعات اليمنية. "
                "أنا مساعد قانوني مخصص للقوانين والتشريعات اليمنية وإدارة مكتب المحاماة فقط."
            )
